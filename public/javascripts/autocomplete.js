...
(function (global, factory) {
      ...
      {},
      {
        ...
        onSubmit: function onSubmit(params) {
          ...
          plugins.forEach(function (x) {
            ...
            return (_x$onSubmit = x.onSubmit) === null || _x$onSubmit === void 0
              ? void 0
        ...
        onReset: function onReset(params) {
          ...
          plugins.forEach(function (x) {
            ...
            return (_x$onReset = x.onReset) === null || _x$onReset === void 0
              ? void 0
    ...
    if (event.key === "ArrowUp" || event.key === "ArrowDown") {
      ...
      var triggerScrollIntoView = function triggerScrollIntoView() {
        var nodeItem = props.environment.document.getElementById(
          "".concat(props.id, "-item-").concat(store.getState().activeItemId)
        );
      ...
      return _objectSpread$6(
        {
          ...
          onReset: function onReset(event) {
            ...
            (_providedProps$inputE2 = providedProps.inputElement) === null ||
            _providedProps$inputE2 === void 0
              ? void 0
  ...
  function getMetadata(_ref) {
    ...
    var optionsKey =
      (_ = (((_options$__autocomple = options.__autocomplete_metadata) ===
        ...
        ? void 0
        : _options$__autocomple.userAgents) || [])[0]) === null || _ === void 0
        ? void 0
        : _.segment;
    ...
    return {
      ...
      ua: userAgents$1.concat(
        ((_options$__autocomple3 = options.__autocomplete_metadata) === null ||
        _options$__autocomple3 === void 0
          ? void 0
  ...
  function getHTMLElement(environment, value) {
    if (typeof value === "string") {
      ...
      invariant(
        element !== null,
        "The element ".concat(JSON.stringify(value), " is not in the document.")
      );
      return element;
    }
  ...
  function x(n, l, u) {
    for (var i, t = n.__k, r = 0; t && r < t.length; r++)
      (i = t[r]) &&
        ((i.__ = n),
        (l =
          "function" == typeof i.type ? x(i, l, u) : P(u, i, i, t, i.__e, l)));
    return l;
  }
        ...
        _objectSpread2(
          ...
          {},
          {
            onStateChange: function onStateChange(params) {
              ...
              (_props$value$core$onS = (_props$value$core = props.value.core)
                .onStateChange) === null || _props$value$core$onS === void 0
                ? void 0
