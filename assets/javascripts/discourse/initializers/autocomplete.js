    ...
    (function (global, factory) {
      ...
      function _objectSpread2(target) {
        for (var i = 1; i < arguments.length; i++) {
          ...
          i % 2
            ? ownKeys$g(Object(source), !0).forEach(function (key) {
      ...
      function getNextActiveItemId(
        ...
        if (
          moveAmount < 0 &&
          (baseIndex === null ||
            (defaultActiveItemId !== null && baseIndex === 0))
        ) {
      ...
      function _objectSpread$f(target) {
        for (var i = 1; i < arguments.length; i++) {
          var source = null != arguments[i] ? arguments[i] : {};
          i % 2
            ? ownKeys$f(Object(source), !0).forEach(function (key) {
        ...
        return Promise.resolve(getSources(params)).then(function (sources) {
          invariant(Array.isArray(sources), function () {
            return "The `getSources` function must return an array of sources but returned type "
              .concat(JSON.stringify(_typeof$1(sources)), ":\n\n")
              .concat(JSON.stringify(decycle(sources), null, 2));
          });
          return Promise.all(
            sources // We allow `undefined` and `false` sources to allow users to use
      ...
      function getCollectionFromActiveItemId(state) {
        ...
        var accumulatedCollectionsCount = state.collections
        ...
        var collectionIndex = accumulatedCollectionsCount.reduce(function (
          acc,
          current
        ) {
      ...
      function mapToAlgoliaResponse(rawResults) {
        var results = rawResults.map(function (result) {
          ...
          return _objectSpread$e(
            _objectSpread$e({}, result),
            {},
            {
              hits:
                (_hits = result.hits) === null || _hits === void 0
                  ? void 0
                  : _hits.map(function (hit) {
        ...
        return {
          ...
          facetHits: results
            .map(function (result) {
              ...
              return (_facetHits = result.facetHits) === null ||
                _facetHits === void 0
                ? void 0
                : _facetHits.map(function (facetHit) {
        ...
        return _objectSpread$b(
          ...
          {},
          {
            ...
            onStateChange: function onStateChange(params) {
              ...
              (_props$onStateChange = props.onStateChange) === null ||
              _props$onStateChange === void 0
                ? void 0
                : _props$onStateChange.call(props, params);
              plugins.forEach(function (x) {
                var _x$onStateChange;

                return (_x$onStateChange = x.onStateChange) === null ||
                  _x$onStateChange === void 0
                  ? void 0
                  : _x$onStateChange.call(x, params);
              });
            },
            onSubmit: function onSubmit(params) {
              var _props$onSubmit;

              (_props$onSubmit = props.onSubmit) === null ||
              _props$onSubmit === void 0
                ? void 0
                : _props$onSubmit.call(props, params);
              plugins.forEach(function (x) {
                var _x$onSubmit;

                return (_x$onSubmit = x.onSubmit) === null ||
                  _x$onSubmit === void 0
                  ? void 0
                  : _x$onSubmit.call(x, params);
              });
            },
            onReset: function onReset(params) {
              var _props$onReset;

              (_props$onReset = props.onReset) === null ||
              _props$onReset === void 0
                ? void 0
                : _props$onReset.call(props, params);
              plugins.forEach(function (x) {
                var _x$onReset;

                return (_x$onReset = x.onReset) === null ||
                  _x$onReset === void 0
                  ? void 0
                  : _x$onReset.call(x, params);
              });
            },
                      ...
                      {},
                      {
                        onSelect: function onSelect(params) {
                          ...
                          pluginSubscribers.forEach(function (x) {
                            ...
                            return (_x$onSelect = x.onSelect) === null ||
                              _x$onSelect === void 0
                              ? void 0
                              : _x$onSelect.call(x, params);
                          });
                        },
                        onActive: function onActive(params) {
                          ...
                          pluginSubscribers.forEach(function (x) {
                            ...
                            return (_x$onActive = x.onActive) === null ||
                              _x$onActive === void 0
                              ? void 0
                              : _x$onActive.call(x, params);
                          });
                        },
                      }
                    );
            ...
            navigator: _objectSpread$b(
              {
                ...
                navigateNewTab: function navigateNewTab(_ref4) {
                  ...
                  var windowReference = environment.open(
                    itemUrl,
                    "_blank",
                    "noopener"
                  );
                  windowReference === null || windowReference === void 0
                    ? void 0
        ...
        var sourcesBySourceId = collections.reduce(function (acc, collection) {
          return _objectSpread$a(
            ...
            _defineProperty$a(
              ...
              _objectSpread$a(
                _objectSpread$a({}, collection.source),
                {},
                {
      ...
      function preResolve(itemsOrDescription, sourceId) {
        if (isRequesterDescription(itemsOrDescription)) {
          return _objectSpread$9(
            _objectSpread$9({}, itemsOrDescription),
            {},
            {
      ...
      function resolve(items) {
        var packed = items.reduce(function (acc, current) {
          ...
          if (container) {
            ...
            (_container$items = container.items).push.apply(
              _container$items,
              _toConsumableArray$3(requests)
            );
          } else {
            var request = {
              execute: execute,
      ...
      function postResolve(responses, sources) {
        return sources.map(function (source) {
          ...
          var items = transform
            ? transform(mapToAlgoliaResponse(results))
            : results;
          invariant(Array.isArray(items), function () {
            return 'The `getItems` function from source "'
              ...
              .concat(JSON.stringify(_typeof(items)), ":\n\n")
              .concat(
      ...
      function onInput(_ref) {
        ...
        if (!query && props.openOnFocus === false) {
          ...
          var collections = store
            .getState()
            .collections.map(function (collection) {
              return _objectSpread$8(
                _objectSpread$8({}, collection),
                {},
                {
                  items: [],
                }
          ...
          setIsOpen(
            (_nextState$isOpen = nextState.isOpen) !== null &&
              _nextState$isOpen !== void 0
              ? _nextState$isOpen
              : props.shouldPanelOpen({
          ...
          var _request = cancelable(
            runConcurrentSafePromise(collections).then(function () {
              // eslint-disable-next-line no-restricted-globals
        ...
        var request = cancelable(
              ...
              .then(function (sources) {
                ...
                return Promise.all(
                  sources.map(function (source) {
                    ...
                    ).then(function (itemsOrDescription) {
          ...
          .then(function (collections) {
            ...
            setIsOpen(
              (_nextState$isOpen2 = nextState.isOpen) !== null &&
                _nextState$isOpen2 !== void 0
                ? _nextState$isOpen2
      ...
      function onKeyDown(_ref) {
        ...
        if (event.key === "ArrowUp" || event.key === "ArrowDown") {
          ...
          var triggerScrollIntoView = function triggerScrollIntoView() {
            var nodeItem = props.environment.document.getElementById(
              ""
                .concat(props.id, "-item-")
                .concat(store.getState().activeItemId)
            );
          ...
          if (
            ...
            store.getState().collections.every(function (collection) {
      ...
      function getPropGetters(_ref) {
        ...
        var getEnvironmentProps = function getEnvironmentProps(providedProps) {
          ...
          function onMouseDownOrTouchStart(event) {
            ...
            var isTargetWithinAutocomplete = [formElement, panelElement].some(
          ...
          return _objectSpread$6(
            {
              ...
              onSubmit: function onSubmit(event) {
                ...
                (_providedProps$inputE = providedProps.inputElement) === null ||
                _providedProps$inputE === void 0
                  ? void 0
                  : _providedProps$inputE.blur();
              },
              onReset: function onReset(event) {
                ...
                (_providedProps$inputE2 = providedProps.inputElement) ===
                  null || _providedProps$inputE2 === void 0
                  ? void 0
                  : _providedProps$inputE2.focus();
              },
            },
            rest
          );
        ...
        var getInputProps = function getInputProps(providedProps) {
                ...
                _objectSpread$6(
                  {
                    ...
                    props: props,
                    query:
                      store.getState().completion || store.getState().query,
                    refresh: refresh,
                    store: store,
                  },
                  setters
          ...
          var userAgent =
            ((_props$environment$na = props.environment.navigator) === null ||
            _props$environment$na === void 0
              ? void 0
              : _props$environment$na.userAgent) || "";
          var shouldFallbackKeyHint = isSamsung(userAgent);
          var enterKeyHint =
            activeItem !== null &&
            activeItem !== void 0 &&
            activeItem.itemUrl &&
            !shouldFallbackKeyHint
              ? "go"
              : "search";
          return _objectSpread$6(
            {
          ...
          return _objectSpread$6(
            {
              ...
              role: "option",
              "aria-selected":
                store.getState().activeItemId === item.__autocomplete_id,
      ...
      function getMetadata(_ref) {
        var _,
          _options$__autocomple,
          _options$__autocomple2,
          _options$__autocomple3;

        var plugins = _ref.plugins,
          options = _ref.options;
        var optionsKey =
          (_ = (((_options$__autocomple = options.__autocomplete_metadata) ===
            null || _options$__autocomple === void 0
            ? void 0
            : _options$__autocomple.userAgents) || [])[0]) === null ||
          _ === void 0
            ? void 0
            : _.segment;
        var extraOptions = optionsKey
          ? _defineProperty$5(
              {},
              optionsKey,
              Object.keys(
                ((_options$__autocomple2 = options.__autocomplete_metadata) ===
                  null || _options$__autocomple2 === void 0
                  ? void 0
                  : _options$__autocomple2.options) || {}
              )
            )
          : {};
        return {
          ...
          ua: userAgents$1.concat(
            ((_options$__autocomple3 = options.__autocomplete_metadata) ===
              null || _options$__autocomple3 === void 0
              ? void 0
              : _options$__autocomple3.userAgents) || []
          ),
        };
      }
      function injectMetadata(_ref3) {
        ...
        var isMetadataEnabled =
          (_environment$navigato = environment.navigator) === null ||
          _environment$navigato === void 0
            ? void 0
            : (_environment$navigato2 = _environment$navigato.userAgent) ===
                null || _environment$navigato2 === void 0
            ? void 0
      ...
      function getCompletion(_ref) {
        ...
        return (
          ((_getActiveItem = getActiveItem(state)) === null ||
          _getActiveItem === void 0
            ? void 0
            : _getActiveItem.itemInputValue) || null
        );
      }
        ...
        switch (action.type) {
          ...
          case "setContext": {
            return _objectSpread$4(
              ...
              {},
              {
                context: _objectSpread$4(
                  _objectSpread$4({}, state.context),
                  action.payload
                ),
              }
            );
      ...
      function createAutocomplete(options) {
        ...
        var propGetters = getPropGetters(
          _objectSpread$3(
            {
              props: props,
              refresh: refresh,
        ...
        props.plugins.forEach(function (plugin) {
          ...
          return (_plugin$subscribe = plugin.subscribe) === null ||
            _plugin$subscribe === void 0
            ? void 0
            : _plugin$subscribe.call(
                plugin,
                _objectSpread$3(
                  _objectSpread$3({}, setters),
                  {},
                  {
                    refresh: refresh,
      ...
      var ClearIcon = function ClearIcon(_ref) {
        ...
        var element = environment.document.createElementNS(
        ...
        var path = environment.document.createElementNS(
          "http://www.w3.org/2000/svg",
          "path"
        );
        path.setAttribute(
        ...
        return values.reduce(function (acc, current) {
          Object.keys(current).forEach(function (key) {
            ...
            if (Array.isArray(accValue) && Array.isArray(currentValue)) {
              acc[key] = accValue.concat.apply(
                accValue,
                _toConsumableArray$5(currentValue)
              );
      ...
      function createAutocompleteDom(_ref) {
        var autocomplete = _ref.autocomplete,
          ...
          placeholder =
            _ref$placeholder === void 0 ? "Search" : _ref$placeholder,
          propGetters = _ref.propGetters,
          setIsModalOpen = _ref.setIsModalOpen,
          state = _ref.state,
          translations = _ref.translations;
        var createDomElement = getCreateDomElement(environment);
        var rootProps = propGetters.getRootProps(
          _objectSpread2(
            {
              state: state,
        ...
        var labelProps = propGetters.getLabelProps(
          _objectSpread2(
            {
              state: state,
        ...
        var formProps = propGetters.getFormProps(
          _objectSpread2(
            {
              state: state,
        ...
        var panelProps = propGetters.getPanelProps(
          _objectSpread2(
            {
              state: state,
      ...
      function createAttributeSet() {
        ...
        return {
          ...
          add: function add(part) {
            ...
            if (
              (lastPart === null || lastPart === void 0
                ? void 0
                : lastPart.isHighlighted) === part.isHighlighted
            ) {
      ...
      function parseAlgoliaHitHighlight(_ref) {
        ...
        var highlightedValue = getAttributeValueByPath(
          hit,
          ["_highlightResult"].concat(_toConsumableArray$2(path), ["value"])
        );
        ...
        if (typeof highlightedValue !== "string") {
          "development" !== "production"
            ? warn(
                false,
                'The attribute "'
                  .concat(path.join("."), '" described by the path ')
                  .concat(
                    JSON.stringify(path),
      ...
      function unescape(value) {
        return value && regexHasEscapedHtml.test(value)
          ? value.replace(regexEscapedHtml, function (character) {
      ...
      function isPartHighlighted(parts, i) {
        ...
        var current = parts[i];
        var isNextHighlighted =
          ((_parts = parts[i + 1]) === null || _parts === void 0
            ? void 0
            : _parts.isHighlighted) || true;
        var isPreviousHighlighted =
          ((_parts2 = parts[i - 1]) === null || _parts2 === void 0
            ? void 0
            : _parts2.isHighlighted) || true;
      ...
      function parseAlgoliaHitSnippet(_ref) {
        ...
        var highlightedValue = getAttributeValueByPath(
          hit,
          ["_snippetResult"].concat(_toConsumableArray$1(path), ["value"])
        );
      ...
      function fetchAlgoliaResults(_ref) {
        ...
        if (typeof searchClient.addAlgoliaAgent === "function") {
          var algoliaAgents = [].concat(
            _toConsumableArray(userAgents$1),
            _toConsumableArray(userAgents)
          );
        ...
        return searchClient
          .search(
            queries.map(function (searchParameters) {
              var params = searchParameters.params,
                headers = _objectWithoutProperties(
                  searchParameters,
                  _excluded$2
                );
      ...
      function getDefaultOptions(options) {
          ...
          ? warn(
              !renderer ||
                ...
                (renderer.Fragment &&
                  ...
                  renderer.render),
              "You provided an incomplete `renderer` (missing: ".concat(
                [
                  !(
                    renderer !== null &&
                    renderer !== void 0 &&
        ...
        var defaultedRenderer = _objectSpread2(
          _objectSpread2({}, defaultRenderer),
          renderer
        );
        ...
        return {
          renderer: {
            classNames: mergeClassNames(
              defaultClassNames,
              classNames !== null && classNames !== void 0 ? classNames : {}
            ),
            container: containerElement,
            getEnvironmentProps:
              getEnvironmentProps !== null && getEnvironmentProps !== void 0
                ? getEnvironmentProps
                : function (_ref2) {
            ...
            getFormProps:
              getFormProps !== null && getFormProps !== void 0
                ? getFormProps
                : function (_ref3) {
            ...
            getInputProps:
              getInputProps !== null && getInputProps !== void 0
                ? getInputProps
                : function (_ref4) {
            ...
            getItemProps:
              getItemProps !== null && getItemProps !== void 0
                ? getItemProps
                : function (_ref5) {
            ...
            getLabelProps:
              getLabelProps !== null && getLabelProps !== void 0
                ? getLabelProps
                : function (_ref6) {
            ...
            getListProps:
              getListProps !== null && getListProps !== void 0
                ? getListProps
                : function (_ref7) {
            ...
            getPanelProps:
              getPanelProps !== null && getPanelProps !== void 0
                ? getPanelProps
                : function (_ref8) {
            ...
            getRootProps:
              getRootProps !== null && getRootProps !== void 0
                ? getRootProps
                : function (_ref9) {
            ...
            panelPlacement:
              panelPlacement !== null && panelPlacement !== void 0
                ? panelPlacement
                : "input-wrapper-width",
            render:
              render !== null && render !== void 0 ? render : defaultRender,
            renderNoResults: renderNoResults,
            renderer: defaultedRenderer,
            detachedMediaQuery:
              detachedMediaQuery !== null && detachedMediaQuery !== void 0
                ? detachedMediaQuery
                : getComputedStyle(
                    environment.document.documentElement
                  ).getPropertyValue("--aa-detached-media-query"),
            components: _objectSpread2(
              _objectSpread2({}, defaultComponents),
              components
            ),
            translations: _objectSpread2(
              _objectSpread2({}, defaultTranslations),
              translations
            ),
          },
          core: _objectSpread2(
            ...
            {
              id:
                (_core$id = core.id) !== null && _core$id !== void 0
                  ? _core$id
                  : generateAutocompleteId(),
              environment: environment,
            }
      ...
      function renderPanel(render, _ref2) {
        ...
        var sections = state.collections
        ...
        var children = renderer.createElement(
          renderer.Fragment,
          null,
          renderer.createElement(
            "div",
      ...
      function autocomplete(options) {
        ...
        var isDetached = reactive(function () {
          return props.value.core.environment.matchMedia(
        ...
        var autocomplete = reactive(function () {
          return createAutocomplete(
            _objectSpread2(
              _objectSpread2({}, props.value.core),
              {},
              {
                onStateChange: function onStateChange(params) {
                  var _onStateChangeRef$cur,
                  ...
                  _onStateChangeRef$cur === void 0
                    ? void 0
                    : _onStateChangeRef$cur.call(onStateChangeRef, params);
                  (_props$value$core$onS = (_props$value$core =
                    props.value.core).onStateChange) === null ||
                  _props$value$core$onS === void 0
                    ? void 0
                    : _props$value$core$onS.call(_props$value$core, params);
                },
                shouldPanelOpen:
                  ...
                  function (_ref) {
                    ...
                    var hasNoResultsTemplate = Boolean(
        ...
        runEffect(function () {
          ...
          return function () {
            setProperties(
              props.value.core.environment,
              Object.keys(environmentProps).reduce(function (acc, key) {
                return _objectSpread2(
                  _objectSpread2({}, acc),
                  {},
                  _defineProperty$g({}, key, undefined)
                );
              }, {})
            );
          };
        ...
        runEffect(function () {
          var panelContainerElement = isDetached.value
            ? props.value.core.environment.document.body
            : props.value.renderer.panelContainer;
          var panelElement = isDetached.value
        ...
        runEffect(function () {
          ...
          return function () {
            props.value.core.environment.removeEventListener(
              "resize",
              onResize
            );
          };
        ...
        runEffect(function () {
          ...
          var isModalDetachedMql = props.value.core.environment.matchMedia(
            getComputedStyle(
          ...
          var hasModernEventListener = Boolean(
            isModalDetachedMql.addEventListener
          );
        ...
        function update() {
          ...
          var _props$value$renderer = props.value.renderer,
            ...
            rendererProps = _objectWithoutProperties$4(
              _props$value$renderer,
              _excluded
            );
        ...
        function setIsModalOpen(value) {
          requestAnimationFrame(function () {
            var prevValue = props.value.core.environment.document.body.contains(
              dom.value.detachedOverlay
            );
            ...
            if (value) {
              ...
              props.value.core.environment.document.body.classList.add(
                "aa-Detached"
              );
        ...
        return _objectSpread2(
          _objectSpread2({}, autocompleteScopeApi),
          {},
          {
            update: update,
            destroy: destroy,
