    ...
    !(function (t, e) {
      ...
      function i(t) {
        var e,
          ...
          n = function () {
            return (
              void 0 === e && (e = t.localStorage || window.localStorage), e
            );
          },
          o = function () {
      ...
      function S(t, e, n, a) {
        var i = [],
          ...
          d = r(
            r(
              r({ "x-algolia-agent": t.userAgent.value }, t.queryParameters),
              f
            ),
            a.queryParameters
          ),
      ...
      function T(t) {
        var e = {
          ...
          add: function (t) {
            ...
            return (
              -1 === e.value.indexOf(r) &&
                (e.value = "".concat(e.value).concat(r)),
              e
            );
          },
        };
      ...
      var W = function (t) {
        ...
        dt = function (t) {
          return function (e) {
            return t.transporter.read(
              { method: x, path: "1/clusters/mapping" },
              e
            );
          };
        },
          ...
          return function (e, o) {
            ...
            return (function n() {
              return ie(t)(u || "", r(r({}, c), {}, { page: f })).then(
                function (t) {
                  for (
                    var r = 0, o = Object.entries(t.hits);
                    r < o.length;
                    r++
                  ) {
                    var i = a(o[r], 2),
